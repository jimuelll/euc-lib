...
-- Add these constraints after AUTO_INCREMENT changes. MySQL 8 rejects
-- changing a referenced column while another table's foreign key exists.
ALTER TABLE `catalog_settings`
...
('publisher', 'Publisher', 'text', NULL, 0, 0, 3, 1, 0, 'book'),
('publication_place', 'Publication Place', 'text', NULL, 0, 0, 4, 1, 0, 'book'),
('copyright_year', 'Copyright Year', 'number', NULL, 0, 0, 5, 1, 0, 'book'),
('edition', 'Edition', 'text', NULL, 0, 0, 6, 1, 0, 'book'),
('physical_description', 'Physical Description', 'textarea', NULL, 0, 0, 7, 1, 0, 'book'),
('category', 'Category', 'select', JSON_ARRAY('Circulation', 'Reserved', 'New Arrival', 'Filipiniana', 'General Reference', 'Special Collection', 'Cultural', 'Fiction'), 0, 0, 8, 1, 0, 'book'),
('call_number', 'Call Number', 'text', NULL, 0, 0, 9, 0, 0, 'book'),
('subjects', 'Subjects', 'repeatable', NULL, 0, 0, 10, 1, 0, 'book'),
('added_title', 'Added Title', 'text', NULL, 0, 0, 11, 1, 0, 'book'),
('series_title', 'Series Title', 'text', NULL, 0, 0, 12, 1, 0, 'book'),
('added_authors', 'Added Authors', 'repeatable', NULL, 0, 0, 13, 1, 0, 'book'),
('editors', 'Editors', 'repeatable', NULL, 0, 0, 14, 1, 0, 'book'),
('coordinators', 'Coordinators', 'repeatable', NULL, 0, 0, 15, 1, 0, 'book'),
('consultants', 'Consultants', 'repeatable', NULL, 0, 0, 16, 1, 0, 'book'),
('contributors', 'Contributors', 'repeatable', NULL, 0, 0, 17, 1, 0, 'book'),
('illustrators', 'Illustrators', 'repeatable', NULL, 0, 0, 18, 1, 0, 'book'),
('copies', 'Copies', 'number', NULL, 0, 1, 19, 1, 0, 'book'),
