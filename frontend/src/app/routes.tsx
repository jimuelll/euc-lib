...
const AdminPayment = lazy(() => import("@/features/clearance/admin/AdminPayment"));
...
const AdminSubscriptions = lazy(() => import("@/features/subscriptions/admin"));
...
const AdminBulletin = lazy(() => import("@/features/bulletin/admin/AdminBulletin"));
