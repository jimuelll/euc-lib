...
const quickLinks = [
  {
    ...
    description: "Explore books, journals, and more.",
    to: "/catalogue",
    icon: BookOpen,
  },
  {
    title: "Research Support",
    description: "Get help with your research needs.",
    to: "/services",
    icon: FileText,
  },
  {
    title: "Library Services",
    description: "Access borrowing, renewal, and more.",
    to: "/services",
    icon: Library,
  },
  {
    title: "Digital Resources",
    description: "Explore e-books and e-journals.",
      ...
      <div className="grid gap-4 lg:grid-cols-[9.5rem_repeat(5,minmax(0,1fr))] lg:items-stretch lg:gap-3">
        <div className="pr-4 lg:py-2">
          ...
          <p className="mt-3 text-xs leading-5 text-muted-foreground">
            Support for every step of your academic journey.
          </p>
        </div>
