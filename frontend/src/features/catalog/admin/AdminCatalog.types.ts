...
export const DEFAULT_FIELDS: FormField[] = [
  ...
  { key: "category",         label: "Category",         type: "select",     options: ["Circulation", "Reserved", "New Arrival", "Filipiniana", "General Reference", "Special Collection", "Cultural", "Fiction"], public: true, order: 8, scope: "book" },
  { key: "call_number",      label: "Call Number",      type: "text",       public: false, order: 9, scope: "book" },
  { key: "subjects",         label: "Subjects",         type: "repeatable", public: true,  order: 10, scope: "book" },
  { key: "added_title",      label: "Added Title",      type: "text",       public: true,  order: 11, scope: "book" },
  { key: "series_title",     label: "Series Title",     type: "text",       public: true,  order: 12, scope: "book" },
  { key: "added_authors",    label: "Added Authors",    type: "repeatable", public: true,  order: 13, scope: "book" },
  { key: "editors",          label: "Editors",          type: "repeatable", public: true,  order: 14, scope: "book" },
  { key: "coordinators",     label: "Coordinators",     type: "repeatable", public: true,  order: 15, scope: "book" },
  { key: "consultants",      label: "Consultants",      type: "repeatable", public: true,  order: 16, scope: "book" },
  { key: "contributors",     label: "Contributors",     type: "repeatable", public: true,  order: 17, scope: "book" },
  { key: "illustrators",     label: "Illustrators",     type: "repeatable", public: true,  order: 18, scope: "book" },
  { key: "copies",           label: "Copies",           type: "number",     public: true,  order: 19, scope: "book" },
];
