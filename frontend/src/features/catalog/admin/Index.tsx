          ...
          {showBackfillProgress ? (
            <>
              ...
              {backfillProgress?.lookupFailed ? <div className="rounded-md border border-warning/40 bg-warning/10 px-3 py-2 text-sm leading-5 text-foreground">
                <p>The online details lookup failed for {backfillProgress.lookupFailed} book{backfillProgress.lookupFailed === 1 ? "" : "s"}. This is separate from the embedding results. You can add details manually to improve recommendations.</p>
