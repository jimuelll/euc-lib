...
const AboutPreviewSection = () => (
  <section className="grid min-w-0 overflow-hidden bg-card lg:grid-cols-[38%_minmax(0,1fr)] lg:border-r lg:border-border">
    <div className="relative aspect-[4/3] overflow-hidden border-b border-border lg:aspect-auto lg:min-h-full lg:border-b-0 lg:border-r">
      ...
      <p className="absolute bottom-5 left-5 max-w-[8rem] text-xs font-bold uppercase leading-5 tracking-[.14em] text-warning">More than books. A brighter tomorrow.</p>
    </div>
    <div className="flex min-w-0 flex-col px-5 py-6 sm:px-7 sm:py-7">
      ...
      <Link to="/about" className="mt-6 inline-flex min-h-11 w-fit items-center gap-3 border border-primary px-4 text-xs font-bold uppercase tracking-[.16em] text-primary transition-colors hover:bg-primary hover:text-primary-foreground">
